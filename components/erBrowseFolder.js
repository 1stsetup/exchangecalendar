		...
		if (rm.length > 0) {
			...
			if (rootFolder) {
				if (rootFolder.getAttribute("IncludesLastItemInRange") == "true") {
					...
					exchWebService.commonFunctions.LOG("FOR MAILING THIS LINE https://github.com/Ericsson/exchangecalendar/issues: IncludesLastItemInRange == false in FindFolderResponse.");
				}
			}
			else {
