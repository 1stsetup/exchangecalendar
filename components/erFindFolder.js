	...
	onSendOk: function _onSendOk(aExchangeRequest, aResp)
	{
		...
		if (aContinue) {
			...
			if (totalItemsInView == 1) {
				try {
					this.argument.folderID = aResp.nsSoap::Body.nsMessages::FindFolderResponse..nsTypes::FolderId.@Id.toString();
					this.argument.changeKey = aResp.nsSoap::Body.nsMessages::FindFolderResponse..nsTypes::FolderId.@ChangeKey.toString();
					var folderClass = aResp.nsSoap::Body.nsMessages::FindFolderResponse..nsTypes::FolderClass.toString();
					this.folderCount++;
