...
exchWebService.forewardEvent = {
	...
	{	
		...
		args.onOk = exchWebService.forewardEvent.callOnOk;
...
exchWebService.commonFunctions.LOG(" ------------ our Load 2222222222222222");
			window.removeEventListener("load", exchWebService.forewardEvent.onLoad, false);
			var args = window.arguments[0];
			var item = args.calendarEvent;
			var calendar = item.calendar;
...
window.addEventListener("load", exchWebService.forewardEvent.onLoad, false);
